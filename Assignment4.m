x=[ 1 1 0 0 1 1]; % Binary Information
...
%XXXXXXXXXXXXXXXXXXXXXXX Binary-ASK modulationXXXXXXXXXXXXXXXXXXXXXXXXXXX%
...
%XXXXXXXXXXXXXXXXXXXX Binary ASK demodulationXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
mn=[];
...
%after ASK demodulationXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
bit=[];
for n=1:length(mn);
if mn(n)==1;
se=ones(1,100);
